...
- Changes requested: CTX-01d (`ara-context` system prompt, date/cwd reminder, `skill://` in `read`/`bash`, CLI wiring). The independent review found blocking defects; see the [2026-09-26 handoff](handoffs/2026-09-26.md).
